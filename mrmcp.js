/*
MrMCP 0.10.76 — Deno-owned event-driven UI and stateless MCP server with explicit context capabilities and an embedded WebView desktop window.
...
*{box-sizing:border-box}html,body{min-height:100%}body{margin:0;font:14px/1.4 system-ui,-apple-system,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 50% -12%,rgba(91,84,232,.18),transparent 38%),linear-gradient(180deg,#fafbff 0%,var(--bg) 100%)}
main{min-height:100vh;min-height:100dvh;display:grid;place-items:center;padding:16px}.card{width:min(100%,580px);background:var(--card);border:1px solid var(--line);border-radius:22px;box-shadow:var(--shadow);padding:24px 26px}.brand{text-align:center}.logo-shell{width:68px;height:68px;margin:0 auto 10px;padding:6px;display:grid;place-items:center;border:1px solid #dedcff;border-radius:18px;background:linear-gradient(145deg,#fff,var(--brand-soft));box-shadow:0 8px 22px rgba(91,84,232,.13)}.logo{display:block;width:100%;height:100%;object-fit:contain;border-radius:13px}.eyebrow{display:inline-flex;align-items:center;padding:3px 8px;border-radius:999px;color:#5149cf;background:var(--brand-soft);font-size:10px;font-weight:750;letter-spacing:.035em;text-transform:uppercase;margin-bottom:6px}h1{font-size:24px;line-height:1.12;letter-spacing:-.02em;margin:0 0 6px}.subtitle{max-width:480px;margin:0 auto;color:var(--muted);font-size:14px}.subtitle strong{color:var(--text)}
.details{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:18px 0 16px}.detail{min-width:0;padding:10px 12px;border:1px solid var(--line);border-radius:12px;background:#fafcff}.detail.wide{grid-column:1/-1}.label{display:block;color:var(--muted);font-size:10px;font-weight:750;letter-spacing:.05em;text-transform:uppercase;margin-bottom:3px}.value{font-size:13px;font-weight:700;overflow-wrap:anywhere}.value code{font:12px/1.35 ui-monospace,SFMono-Regular,Consolas,monospace;color:#344054}.notice{display:flex;gap:9px;align-items:flex-start;padding:11px 13px;border-radius:12px;margin:14px 0 0}.notice.error{background:var(--error-bg);border:1px solid var(--error-line);color:#7f3640}.notice.error strong{color:var(--error)}.notice-icon{font-size:15px;line-height:1.3}.actions{display:flex;justify-content:center;gap:10px}.btn{appearance:none;border:0;border-radius:11px;min-width:170px;padding:11px 18px;font:750 13px system-ui,-apple-system,"Segoe UI",sans-serif;cursor:pointer;transition:transform .12s ease,background .12s ease,box-shadow .12s ease}.btn:hover{transform:translateY(-1px)}.approve{color:#fff;background:var(--approve);box-shadow:0 7px 18px rgba(21,149,111,.22)}.approve:hover{background:var(--approve-hover)}.deny{color:#fff;background:var(--deny);box-shadow:0 7px 18px rgba(233,85,85,.16)}.deny:hover{background:var(--deny-hover)}.foot{text-align:center;color:#8a96a8;font-size:10px;margin:14px 0 0}.error-card{border-color:#ecd2d6}
@media(max-width:560px){main{padding:10px}.card{padding:20px 16px;border-radius:18px}.logo-shell{width:60px;height:60px;border-radius:16px}.details{grid-template-columns:1fr;gap:6px;margin:14px 0}.detail.wide{grid-column:auto}.actions{gap:8px}.btn{flex:1;min-width:0}}
@media(max-height:650px){main{padding:8px}.card{padding:16px 20px}.logo-shell{width:54px;height:54px;margin-bottom:7px}.eyebrow{margin-bottom:4px}h1{font-size:21px;margin-bottom:4px}.subtitle{font-size:12px}.details{gap:6px;margin:12px 0}.detail{padding:8px 10px}.foot{margin-top:9px}}
  ...
  async function handleUiAction(event) {
    ...
    switch (action) {
      ...
      case "header-tool-calls":
        ...
        uiState.logs.query = "";
        uiState.logs.status = ["running", "failed"].includes(String(data.status || "")) ? String(data.status) : "";
        uiState.logs.page = 1;
        uiState.logs.openRowId = "";
        uiState.logs.selfTest = null;
        break;
