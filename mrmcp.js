/*
MrMCP 0.10.78 — Deno-owned event-driven UI and stateless MCP server with explicit context capabilities and an embedded WebView desktop window.
...
*{box-sizing:border-box}html,body{width:100%;height:100%;overflow:hidden}body{margin:0;font:1.05vmin/1.28 system-ui,-apple-system,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 50% -10%,rgba(57,132,232,.12),transparent 36%),var(--bg)}
main{width:100vw;height:100vh;height:100dvh;display:grid;place-items:center;padding:2vh 2vw}.card{width:min(52vw,72vh);max-height:90vh;max-height:90dvh;background:var(--card);border:.08vmin solid var(--line);border-radius:1.4vmin;box-shadow:var(--shadow);padding:1.7vh 1.5vw}.brand{text-align:center}.logo-shell{width:4.5vh;height:4.5vh;margin:0 auto .7vh;padding:.35vh;display:grid;place-items:center;border:.08vmin solid #343944;border-radius:1vmin;background:linear-gradient(145deg,#20242a,var(--panel));box-shadow:0 .6vh 1.8vh rgba(0,0,0,.24)}.logo{display:block;width:100%;height:100%;object-fit:contain;border-radius:.75vmin}.eyebrow{display:inline-flex;align-items:center;padding:.2vh .55vw;border-radius:99vmax;color:#9ecbff;background:var(--brand-soft);font-size:.8vmin;font-weight:750;letter-spacing:.035em;text-transform:uppercase;margin-bottom:.4vh}h1{font-size:2.1vmin;line-height:1.06;letter-spacing:-.02em;margin:0 0 .4vh}.subtitle{max-width:42vw;margin:0 auto;color:var(--muted);font-size:1.15vmin}.subtitle strong{color:var(--text)}
.details{margin:1.2vh 0 1vh;border:.08vmin solid var(--line);border-radius:1vmin;background:var(--panel);overflow:hidden}.detail{min-width:0;display:grid;grid-template-columns:10vw minmax(0,1fr);gap:.8vw;align-items:center;padding:.65vh .8vw;border-bottom:.08vmin solid var(--line)}.detail:last-child{border-bottom:0}.label{display:block;color:var(--muted);font-size:.85vmin;font-weight:750;letter-spacing:.04em;text-transform:uppercase}.value{min-width:0;font-size:1.05vmin;font-weight:700;overflow-wrap:anywhere}.value code{font:.95vmin/1.22 ui-monospace,SFMono-Regular,Consolas,monospace;color:#9ecbff}.notice{display:flex;gap:.6vw;align-items:flex-start;padding:.8vh .8vw;border-radius:.8vmin;margin:.8vh 0 0}.notice.error{background:var(--error-bg);border:.08vmin solid var(--error-line);color:#d9a0a7}.notice.error strong{color:var(--error)}.notice-icon{font-size:1.1vmin;line-height:1.3}.actions{display:flex;justify-content:center;gap:.8vw}.btn{appearance:none;border:0;border-radius:.8vmin;min-width:0;flex:1;padding:.9vh 1vw;font:750 1.05vmin system-ui,-apple-system,"Segoe UI",sans-serif;cursor:pointer;transition:transform .12s ease,background .12s ease,box-shadow .12s ease}.btn:hover{transform:translateY(-.1vh)}.approve{color:#fff;background:var(--approve);box-shadow:0 .5vh 1.4vh rgba(21,149,111,.18)}.approve:hover{background:var(--approve-hover)}.deny{color:#fff;background:var(--deny);box-shadow:0 .5vh 1.4vh rgba(233,85,85,.12)}.deny:hover{background:var(--deny-hover)}.foot{text-align:center;color:#737b87;font-size:.75vmin;margin:.8vh 0 0}.error-card{border-color:#5b2d32}
