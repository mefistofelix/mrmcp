/*
MrMCP 0.10.77 — Deno-owned event-driven UI and stateless MCP server with explicit context capabilities and an embedded WebView desktop window.
...
*{box-sizing:border-box}html,body{min-height:100%}body{margin:0;font:12.5px/1.32 system-ui,-apple-system,"Segoe UI",sans-serif;color:var(--text);background:radial-gradient(circle at 50% -10%,rgba(57,132,232,.12),transparent 36%),var(--bg)}
main{min-height:100vh;min-height:100dvh;display:grid;place-items:center;padding:18px}.card{width:min(88vw,480px);background:var(--card);border:1px solid var(--line);border-radius:18px;box-shadow:var(--shadow);padding:18px 20px}.brand{text-align:center}.logo-shell{width:50px;height:50px;margin:0 auto 7px;padding:4px;display:grid;place-items:center;border:1px solid #343944;border-radius:14px;background:linear-gradient(145deg,#20242a,var(--panel));box-shadow:0 6px 18px rgba(0,0,0,.24)}.logo{display:block;width:100%;height:100%;object-fit:contain;border-radius:10px}.eyebrow{display:inline-flex;align-items:center;padding:2px 7px;border-radius:999px;color:#9ecbff;background:var(--brand-soft);font-size:9px;font-weight:750;letter-spacing:.035em;text-transform:uppercase;margin-bottom:4px}h1{font-size:20px;line-height:1.08;letter-spacing:-.02em;margin:0 0 4px}.subtitle{max-width:400px;margin:0 auto;color:var(--muted);font-size:12px}.subtitle strong{color:var(--text)}
.details{margin:13px 0 12px;border:1px solid var(--line);border-radius:12px;background:var(--panel);overflow:hidden}.detail{min-width:0;display:grid;grid-template-columns:120px minmax(0,1fr);gap:10px;align-items:center;padding:7px 10px;border-bottom:1px solid var(--line)}.detail:last-child{border-bottom:0}.label{display:block;color:var(--muted);font-size:9px;font-weight:750;letter-spacing:.045em;text-transform:uppercase}.value{min-width:0;font-size:11.5px;font-weight:700;overflow-wrap:anywhere}.value code{font:10.5px/1.3 ui-monospace,SFMono-Regular,Consolas,monospace;color:#9ecbff}.notice{display:flex;gap:8px;align-items:flex-start;padding:9px 10px;border-radius:10px;margin:11px 0 0}.notice.error{background:var(--error-bg);border:1px solid var(--error-line);color:#d9a0a7}.notice.error strong{color:var(--error)}.notice-icon{font-size:13px;line-height:1.3}.actions{display:flex;justify-content:center;gap:8px}.btn{appearance:none;border:0;border-radius:9px;min-width:140px;padding:9px 14px;font:750 11.5px system-ui,-apple-system,"Segoe UI",sans-serif;cursor:pointer;transition:transform .12s ease,background .12s ease,box-shadow .12s ease}.btn:hover{transform:translateY(-1px)}.approve{color:#fff;background:var(--approve);box-shadow:0 6px 16px rgba(21,149,111,.2)}.approve:hover{background:var(--approve-hover)}.deny{color:#fff;background:var(--deny);box-shadow:0 6px 16px rgba(233,85,85,.14)}.deny:hover{background:var(--deny-hover)}.foot{text-align:center;color:#737b87;font-size:9px;margin:9px 0 0}.error-card{border-color:#5b2d32}
@media(max-width:520px){main{padding:10px}.card{width:min(94vw,440px);padding:15px 14px;border-radius:16px}.detail{grid-template-columns:105px minmax(0,1fr);gap:8px;padding:6px 8px}.actions{gap:7px}.btn{flex:1;min-width:0}}
@media(max-height:560px){main{padding:7px}.card{padding:12px 16px}.logo-shell{width:40px;height:40px;margin-bottom:4px;border-radius:11px}.eyebrow{margin-bottom:2px}h1{font-size:17px;margin-bottom:2px}.subtitle{font-size:10.5px}.details{margin:9px 0 8px}.detail{padding:5px 8px}.label{font-size:8px}.value{font-size:10.5px}.value code{font-size:9.5px}.btn{padding:7px 11px;font-size:10.5px}.foot{margin-top:6px;font-size:8px}}
