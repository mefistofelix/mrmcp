...
MrMCP 0.10.85 consists of four root project files plus one versioned asset directory:
...
25. Confirm the desktop shell uses only `import { Tauriless } from "npm:@mefistofelix/tauriless";`, with no hand-written FFI wrapper, vendored Tauriless native binaries, Rust/Tauri scaffold, Neutralinojs, npm project files or CLI files.
